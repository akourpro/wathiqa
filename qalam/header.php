        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item <?php if (setTitle(escUrl($_SERVER['PHP_SELF'])) == "qalama_index") echo "active"; ?>">
                    ...
                    <li class="menu-item <?php if (setTitle(escUrl($_SERVER['PHP_SELF'])) == "qalama_templates") echo "active"; ?>">
                    ...
                    <li class="menu-item <?php if (setTitle(escUrl($_SERVER['PHP_SELF'])) == "qalama_home") echo "active"; ?>">
                    ...
                    <li class="menu-item <?php if (setTitle(escUrl($_SERVER['PHP_SELF'])) == "qalama_language") echo "active"; ?>">
